...
void isr_EINT0_dummy( void)        __attribute__ ((interrupt ("IRQ")));
void isr_EINT1_dummy( void )     __attribute__ ((interrupt ("IRQ")));
void isr_EINT2_dummy( void )       __attribute__ ((interrupt ("IRQ")));
void isr_EINT3_dummy( void )       __attribute__ ((interrupt ("IRQ")));
void isr_EINT456_dummy( void )    __attribute__ ((interrupt ("IRQ")));
void isr_TICK_dummy( void )    __attribute__ ((interrupt ("IRQ")));
void isr_INT_ZDMA0_dummy( void )       __attribute__ ((interrupt ("IRQ")));
void isr_INT_ZDMA1_dummy( void )       __attribute__ ((interrupt ("IRQ")));

void isr_BDMA0_dummy( void)        __attribute__ ((interrupt ("IRQ")));
void isr_INT_BDMA1_dummy( void )     __attribute__ ((interrupt ("IRQ")));
void isr_INT_WDT_dummy( void )       __attribute__ ((interrupt ("IRQ")));
void isr_INT_UERR01_dummy( void )       __attribute__ ((interrupt ("IRQ")));
void isr_INT_TIMER0_dummy( void )    __attribute__ ((interrupt ("IRQ")));
void isr_INT_TIMER1_dummy( void )    __attribute__ ((interrupt ("IRQ")));
void isr_INT_TIMER2_dummy( void )       __attribute__ ((interrupt ("IRQ")));
void isr_INT_TIMER3_dummy( void )       __attribute__ ((interrupt ("IRQ")));

void isr_INT_TIMER4_dummy( void)        __attribute__ ((interrupt ("IRQ")));
void isr_INT_TIMER5_dummy( void )     __attribute__ ((interrupt ("IRQ")));
void isr_INT_URXD0_dummy( void )       __attribute__ ((interrupt ("IRQ")));
void isr_INT_URXD1_dummy( void )       __attribute__ ((interrupt ("IRQ")));
void isr_INT_IIC_dummy( void )    __attribute__ ((interrupt ("IRQ")));
void isr_INT_SIO_dummy( void )    __attribute__ ((interrupt ("IRQ")));
void isr_INT_UTXD0_dummy( void )       __attribute__ ((interrupt ("IRQ")));
void isr_INT_UTXD1_dummy( void )        __attribute__ ((interrupt ("IRQ")));
void isr_INT_PB_dummy(void)      __attribute__ ((interrupt ("IRQ")));
void isr_INT_ETHERNET_dummy (void) __attribute__ ((interrupt ("IRQ")));
void isr_INT_TS_dummy (void)  __attribute__ ((interrupt ("IRQ")));
void isr_INT_KEYPAD_dummy (void)  __attribute__ ((interrupt ("IRQ")));
...
static void port_init( void )
{
	PDATA = ~0;
		    ...
		    PDATB = ~0;
		    PCONB &= ~( (1<<10) | (1<<9) );  // PB[10] = out, PF[9] = out; LEDS
...
{ 
	...
	pISR_UTXD1   = (uint32) isr_INT_UTXD1_dummy;
	pISR_UTXD0   = (uint32)isr_INT_UTXD0_dummy;
	pISR_SIO     = (uint32)isr_INT_SIO_dummy;
	pISR_IIC     = (uint32)isr_INT_IIC_dummy;
	pISR_URXD1   = (uint32)isr_INT_URXD1_dummy;
	pISR_URXD0   = (uint32)isr_INT_URXD0_dummy;
	pISR_TIMER5  = (uint32)isr_INT_TIMER5_dummy;
	pISR_TIMER4  = (uint32)isr_INT_TIMER4_dummy;
	pISR_TIMER3  = (uint32)isr_INT_TIMER3_dummy;
	pISR_TIMER2  = (uint32)isr_INT_TIMER2_dummy;
	pISR_TIMER1  = (uint32)isr_INT_TIMER1_dummy;
	pISR_TIMER0  = (uint32)isr_INT_TIMER0_dummy;
	pISR_UERR01  =(uint32) isr_INT_UERR01_dummy;
	pISR_WDT     = (uint32)isr_INT_WDT_dummy;
	pISR_BDMA1   = (uint32) isr_INT_BDMA1_dummy;
	pISR_BDMA0   =(uint32) isr_BDMA0_dummy;
	pISR_ZDMA1   = (uint32)isr_INT_ZDMA1_dummy;
	pISR_ZDMA0   = (uint32) isr_INT_ZDMA0_dummy;
	pISR_TICK 	 = (uint32)isr_TICK_dummy;

 	pISR_ETHERNET= (uint32)isr_INT_ETHERNET_dummy;
	pISR_TS      = (uint32)isr_INT_TS_dummy;
	pISR_KEYPAD  = (uint32)isr_INT_KEYPAD_dummy;
	pISR_USB     = (uint32) isr_USB_dummy;
	pISR_PB      = (uint32)isr_INT_PB_dummy;
}
...
{
	uart0_puts( "\n\n*** ERROR FATAL: ejecutando isr_UTDX1_dummy" );
	SEGS = 0x75;
	while( 1 );
}
...
{
	uart0_puts( "\n\n*** ERROR FATAL: ejecutando isr_UTDX0_dummy" );
	SEGS = 0x75;
	while( 1 );
}
